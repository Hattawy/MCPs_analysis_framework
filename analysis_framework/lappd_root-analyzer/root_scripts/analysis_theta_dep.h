...
// from TChain ch/analysis_theta_dep
//////////////////////////////////////////////////////////

#ifndef analysis_theta_dep_h
#define analysis_theta_dep_h
...
public :
 ...
 //UVevent         *evt;
   ...
   analysis_theta_dep(TTree *tree=0);
   virtual ~analysis_theta_dep();
...
#ifdef analysis_theta_dep_cxx
analysis_theta_dep::analysis_theta_dep(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      // of trees.
      TChain * chain = new TChain("ch","analysis_theta_dep");
      chain->Add("../rootfiles/rootfile_run_22*.root/lappd");
      chain->Add("../rootfiles/rootfile_run_40*.root/lappd");
      tree = chain;
#endif // SINGLE_TREE
...
analysis_theta_dep::~analysis_theta_dep()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analysis_theta_dep::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis_theta_dep::LoadTree(Long64_t entry)
{
...
void analysis_theta_dep::Init(TTree *tree)
{
...
Bool_t analysis_theta_dep::Notify()
{
...
void analysis_theta_dep::Show(Long64_t entry)
{
...
Int_t analysis_theta_dep::Cut(Long64_t entry)
{
...
#endif // #ifdef analysis_theta_dep_cxx
