...
// from TChain ch/analysis_tube69_CathodeHV_diff_B
//////////////////////////////////////////////////////////

#ifndef analysis_tube69_CathodeHV_diff_B_h
#define analysis_tube69_CathodeHV_diff_B_h
...
class analysis_tube69_CathodeHV_diff_B {
public :
 ...
 //UVevent         *evt;
   ...
   analysis_tube69_CathodeHV_diff_B(TTree *tree=0);
   virtual ~analysis_tube69_CathodeHV_diff_B();
...
#ifdef analysis_tube69_CathodeHV_diff_B_cxx
analysis_tube69_CathodeHV_diff_B::analysis_tube69_CathodeHV_diff_B(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      // of trees.
      TChain * chain = new TChain("ch","analysis_tube69_CathodeHV_diff_B");
      chain->Add("../rootfiles-march3d/rootfile_run_11*.root/lappd");
      //chain->Add("../rootfiles/rootfile_run_1*.root/lappd");
      tree = chain;
#endif // SINGLE_TREE
...
analysis_tube69_CathodeHV_diff_B::~analysis_tube69_CathodeHV_diff_B()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analysis_tube69_CathodeHV_diff_B::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis_tube69_CathodeHV_diff_B::LoadTree(Long64_t entry)
{
...
void analysis_tube69_CathodeHV_diff_B::Init(TTree *tree)
{
...
Bool_t analysis_tube69_CathodeHV_diff_B::Notify()
{
...
void analysis_tube69_CathodeHV_diff_B::Show(Long64_t entry)
{
...
Int_t analysis_tube69_CathodeHV_diff_B::Cut(Long64_t entry)
{
...
#endif // #ifdef analysis_tube69_CathodeHV_diff_B_cxx
