...
// from TChain ch/analysis_tube69_HV_diff_B_2nd_set
//////////////////////////////////////////////////////////

#ifndef analysis_tube69_HV_diff_B_2nd_set_h
#define analysis_tube69_HV_diff_B_2nd_set_h
...
class analysis_tube69_HV_diff_B_2nd_set {
public :
 ...
 //UVevent         *evt;
   ...
   analysis_tube69_HV_diff_B_2nd_set(TTree *tree=0);
   virtual ~analysis_tube69_HV_diff_B_2nd_set();
...
#ifdef analysis_tube69_HV_diff_B_2nd_set_cxx
analysis_tube69_HV_diff_B_2nd_set::analysis_tube69_HV_diff_B_2nd_set(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      // of trees.
      TChain * chain = new TChain("ch","analysis_tube69_HV_diff_B_2nd_set");
      chain->Add("../rootfiles/rootfile_run_30*.root/lappd");
      tree = chain;
#endif // SINGLE_TREE
...
analysis_tube69_HV_diff_B_2nd_set::~analysis_tube69_HV_diff_B_2nd_set()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analysis_tube69_HV_diff_B_2nd_set::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis_tube69_HV_diff_B_2nd_set::LoadTree(Long64_t entry)
{
...
void analysis_tube69_HV_diff_B_2nd_set::Init(TTree *tree)
{
...
Bool_t analysis_tube69_HV_diff_B_2nd_set::Notify()
{
...
void analysis_tube69_HV_diff_B_2nd_set::Show(Long64_t entry)
{
...
Int_t analysis_tube69_HV_diff_B_2nd_set::Cut(Long64_t entry)
{
...
#endif // #ifdef analysis_tube69_HV_diff_B_2nd_set_cxx
